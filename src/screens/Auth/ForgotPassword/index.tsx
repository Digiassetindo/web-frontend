...
class NewForgotPasswordClass extends Component<Props, ForgotPasswordState> {
      ...
      return (
         ...
         >
            <FormForgotPassword
               ...
               subTitle="For security purposes, no withdrawals are permitted for 24 hours after password changed."
               subTitleOtp="To secure your account, please complete the following verification."
               ...
               placeholder="Enter your email to forgot password"
...
)(NewForgotPasswordClass) as React.ComponentClass;
