...
export const Header: FC<HeaderProps> = ({ txtLogin, txtSignup, isLogined, isFull }) => {
         ...
         <div className="header__center center">
            ...
            <div className="header__wrapper">
               <div className="header__wrap js-header-wrap">
                  ...
                  <a className="button-stroke header__button" href="wallet-overview.html">Wallet</a>
               </div>
               ...
               </div>
               {
                  isLogined && (
                     <div className="header__control">
                        ...
                        <a className="button-stroke button-small header__button" href="wallet-overview.html">Wallet</a>
